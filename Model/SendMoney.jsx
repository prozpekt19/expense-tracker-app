...
<View>
  <Text style={styles.SenderName}>Jarin Jaison</Text>
  <Text style={styles.SenderId}>Food</Text>
    ...
    <View style={styles.NumPad}>
      ...
      >
        ...
        <View style={styles.SendBtn}>
          <Text style={styles.SendTxt}>Spent</Text>
        </View>
        </TouchableOpacity>
      </View>
    </View>
  ...
  return (
    <View style={styles.SendMoney}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("Home")}>
        ...
        <Text style={styles.Analytics}>Money Spent </Text>
        <TouchableOpacity onPress={() => navigation.navigate("Home")}>
          <View style={styles.BellContiner}>
