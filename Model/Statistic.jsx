  ...
  return (
    <View style={styles.BillsDue}>
      ...
      >
        ...
        >
          <Bill BillImage={keells} PayerName={'Keells'} PayerType={'Shopping '}/>
          ...
          <Bill BillImage={keells} PayerName={'Keells'} PayerType={'Shopping '}/>
          <Bill BillImage={pizza} PayerName={'Pizza'} PayerType={'Food'}/>
          <Bill BillImage={apple} PayerName={'Apple'} PayerType={'Shopping '}/><Bill BillImage={keells} PayerName={'Keells'} PayerType={'Shopping '}/>
          <Bill BillImage={pizza} PayerName={'Pizza'} PayerType={'Food'}/>
          <Bill BillImage={apple} PayerName={'Apple'} PayerType={'Shopping '}/>
  ...
  return (
    <View style={styles.Bill}>
      ...
      <View style={{flexDirection:'row', gap: 10 ,}}>
        ...
        <Text style={[styles.PaymentVal,{color:'blue'}]}>₹</Text>
...
const Statistic = () => {
  return (
    <View style={styles.Stat}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} fadingEdgeLength={60} style={{marginTop:10,borderRadius:20,marginBottom:-50}}>
      <GraphCard />
      <BillsDue />
      </ScrollView>
      <BottomBar />
