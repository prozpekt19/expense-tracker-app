  ...
  return (
    <View style={styles.AddCardContainer}>
      <View style={styles.AddCard}>
        <Text style={{ color: "#757575", fontWeight: "500" }}>+ Add Card / Account</Text>
      </View>
    </View>
  );
};
...
const TopBtn = ({ selectedType, setSelectedType }) => {
  ...
  return (
    <View style={{ flexDirection: "row" }}>
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} fadingEdgeLength={25}>
        <TouchableOpacity
          style={[
            styles.CardType,
            selectedType === "All Cards" && { backgroundColor: "blue" },
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.CardType,
            selectedType === "Debit" && { backgroundColor: "green" },
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.CardType,
            selectedType === "Credit" && { backgroundColor: "red" },
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.CardType,
            selectedType === "Virtual" && { backgroundColor: "orange" },
          ]}
